...
{
	int N = Pmats.size(), M = pointcloud.size(), K = Count2DMeasurements(pointcloud);//Q
	...
	// Normalize the intrinsic to have unit focal length. // improtant procedure 
	...
	//convert 2D measurements to BA datastructs //Q
